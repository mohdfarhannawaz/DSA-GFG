...
4 &lt; 8 so print 'lesser'.</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
<span style="font-size: 18px;"><strong>Explanation:</strong>
8 = 8 so print 'equal'.</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
